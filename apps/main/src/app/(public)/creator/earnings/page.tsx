  ...
  return (
    <div className="max-w-[900px] mx-auto px-6 py-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
        ...
        <p className="text-sm text-zinc-500 mt-1">Manage your diamond balance and withdrawals</p>
      </motion.div>
      ...
      <div className="glass rounded-2xl p-6 mb-6">
        ...
        <p className="text-xs text-zinc-500 mt-1">≈ ${(diamonds * 0.001).toFixed(2)} USD (1000 💎 = $1)</p>
      </div>
